...
In this exercise I am presenting an example what can you do with the gutenberg R package combining with the tidytext and the tidyverse package. Then do some basic piloting with ggplot.
...
#### Use the unnest tokens fuction to split the data to words:
```{r, , warning=FALSE, message=FALSE}
