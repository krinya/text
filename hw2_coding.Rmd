...
```{r, warning=FALSE, message=FALSE}
ggplot(word_counts2, aes(x = word_counts2[,2], y = word_counts2[,3])) +
geom_abline(slope =1, linetype=3) + geom_jitter(alpha = 0.1, alpha = 0.1 , color = "blue") +
labs(title = paste(c("Word frequincies of:", colnames(word_counts2)[2], "vs",colnames(word_counts2)[3]), collapse = " "), x = colnames(word_counts2)[2], y = colnames(word_counts2)[3]) +
geom_text(aes(label = word), color = "blue", alpha = 0.3) +
